...
class NotificationController {
  ...
  static Future init() async {
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      ...
      if (message.notification != null) {
        showSimpleNotification(title: message.notification!.title!, body: message.notification!.body!, payload: payloadData);
      }
    });
  ...
  static Future<String?> getTokenCell() async {
  ...
  static Future firebaseBackgroundMessage(RemoteMessage message) async {
    String payloadData = jsonEncode(message.data);
    debugPrint("Got a message in background");
    if (message.notification != null) {
      showSimpleNotification(title: message.notification!.title!, body: message.notification!.body!, payload: payloadData);
    }
  }
